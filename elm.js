			...
			case 'Add':
				...
				return _Utils_update(
					model,
					{
						...
						entries: A2(
							elm$core$List$cons,
							_Utils_Tuple2(model.lastId, _new),
							model.entries),
					...
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$Main$onEnter(
										author$project$Main$Add(model.content))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								A2(
									elm$core$List$map,
									author$project$Main$viewEntry(model.selected),
									model.entries))
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('http://sindresorhus.com')
											]),
										_List_fromArray(
											[
												elm$html$Html$text('Sindre Sorhus')
											]))
									])),
								A2(
								elm$html$Html$p,
